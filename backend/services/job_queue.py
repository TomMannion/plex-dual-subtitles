...
class JobQueue:
    ...
    def __init__(self, max_concurrent_jobs: int = 2):
        ...
        logger.info(f"JobQueue initialized with max_concurrent_jobs={max_concurrent_jobs}")
    ...
    def create_job(
        ...
        logger.info(f"Job created: {job_id} ({job_type.value}) - {title}")
        return job_id
    ...
    def start_job(self, job_id: str, job_func: Callable, *args, **kwargs) -> bool:
        ...
        logger.info(f"Job started: {job_id} - {job.title}")
    ...
    def complete_job(self, job_id: str, result: Dict[str, Any]):
        ...
        with self._lock:
            ...
            if job:
                ...
                logger.info(f"Job completed: {job_id} - {job.title}")
    ...
    def fail_job(self, job_id: str, error: str):
        ...
        with self._lock:
            ...
            if job:
                ...
                logger.error(f"Job failed: {job_id} - {job.title}")
    ...
    def cancel_job(self, job_id: str) -> bool:
        ...
        with self._lock:
            ...
            if job.status == JobStatus.PENDING:
                ...
                logger.info(f"Job cancelled (pending): {job_id}")
                return True
                ...
                logger.info(f"Job cancellation requested (running): {job_id}")
                return True
            else:
                return False
